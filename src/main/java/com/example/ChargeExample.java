...
public class ChargeExample {
    ...
    public Charge createCharge() {
        ...
        chargeMap.put("subject", "pingpp测试 subject");
        chargeMap.put("body", "pingpp 测试订单 body");
        String orderNo = "123123123";//new Date().getTime() + Main.randomString(7);
...
//        extra.put("open_id", "USER_OPENID");
    ...
    public Charge createChargeWithOpenid(String openid) {
        ...
        String orderNo = "123123213";//new Date().getTime() + Main.randomString(7);
        chargeMap.put("order_no", orderNo);// 推荐使用 8-20 位，要求数字或字母，不允许其他字符
